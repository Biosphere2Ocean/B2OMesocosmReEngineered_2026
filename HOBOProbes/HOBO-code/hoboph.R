...
#import hobo ph data
setwd("C:/Users/fried/OneDrive/Desktop/HOBO pH Data") #your data directory. might work with the "Box Sync" client as well, haven't tried
csv <- list.files(pattern = ".csv") #create list of csvs in directory
xls<-list.files(pattern = ".xls") #create list of excel files in director
...
hoboph<-rbind(hobocsv,hoboxls) #bind the two data frames
